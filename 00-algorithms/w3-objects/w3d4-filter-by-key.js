 ...
 * @param {string} searchMethod The method to search with.
...
const result1 = functionalFilterByKey(people, searchFor1, searchBy1);
console.log(result1);

const result2 = functionalFilterByKey(people, searchFor2, searchBy2);
console.log(result2);

const result3 = functionalFilterByKey(people, searchFor3, searchBy3);
console.log(result3);

const result4 = functionalFilterByKey(
  people,
  searchFor4,
  searchBy4,
  searchMethod4
