...
function mergeCarts(shoppingCart, wishList) {
  return [...new Set(shoppingCart.concat(wishList))];
}

const merged1 = mergeCarts(shoppingCart1, wishList1);
const merged2 = mergeCarts(shoppingCart2, wishList2);
const merged3 = mergeCarts(shoppingCart3, wishList3);
const merged4 = mergeCarts(shoppingCart4, wishList4);
