/*
  ...
  (aka disjunctive union)
    ...
    - these are the elements which are in either of the sets and
      ...
      middle part is not filled in (the intersection is excluded)
    - i.e., if an element is in at least one of the arrays, but not
      in any other, it should be included (dupes included 1 time
      only)
...
/* 
  Explanation: 1, 2, and 3 are shared so are excluded
    ...
    have duplicates, so only one copy of each is kept.
*/
